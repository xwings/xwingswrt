...
TARGET_DEVICES += airpi-ap3000e
    ...
    sed -i '/mt7981-wo-firmware\/install/a \\tcp $(BUILD_DIR)/../../../config/airpi-ap3000e/firmware/mt7981_eeprom_mt7976_dbdc.bin $(PKG_BUILD_DIR)/mediatek\/mt7981_eeprom_mt7976_dbdc.bin' lede/package/firmware/linux-firmware/mediatek.mk
    sed -i '/mt7981_wo.bin/a \\t\t$(PKG_BUILD_DIR)/mediatek/mt7981_eeprom_mt7976_dbdc.bin \\' lede/package/firmware/linux-firmware/mediatek.mk
}